...
`);return Mt.parse(i)};var be=Ut,Ae=m((s,i)=>{const a=le,n=a(s,"r"),u=a(s,"g"),l=a(s,"b");return ue(n,u,l,i)},"fade"),ke=m(s=>`.label {
...
`,"getStyles"),me=ke,De={parser:be,get db(){return new de},renderer:ge,styles:me,init:m(s=>{s.flowchart||(s.flowchart={}),s.layout&&Ot({layout:s.layout}),s.flowchart.arrowMarkerAbsolute=s.arrowMarkerAbsolute,Ot({flowchart:{arrowMarkerAbsolute:s.arrowMarkerAbsolute}})},"init")};export{De as diagram};
