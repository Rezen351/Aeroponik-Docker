...
<li><b>Cell Change (by user in-cell editing) </b><pre><code>cellEditing, cellEdited, cellEditCancelled</code></pre></li>
...
<li><p><code>tbTestConnection</code>: tests the socket listener between the Node-RED server and dashboard clients.<br>
	For each active client connection, it prints to the console as well as replies with a message<br></p></li>
